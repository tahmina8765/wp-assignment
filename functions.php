...
if (!function_exists('life_setup')) :
    ...
    function life_setup()
    {
         ...
         * If you're building a theme based on life, use a find and replace
         * to change 'life' to the name of your theme in all the template files
         */
        ...
        add_theme_support('custom-background', apply_filters('life_custom_background_args', array (
...
function life_scripts()
{
    ...
    wp_enqueue_style('bootstrap-css', '//maxcdn.bootstrapcdn.com/bootstrap/3.3.2/css/bootstrap.min.css');
